...
Page({
  ...
  prePoem: function(e) {
    if (this.data.poemElementNum == 0) {
      ...
      wx.request({
        url: 'https://www.wshuai.club:8088/huamanxi_wx/pageController/toPoetryPage?poemElementNum=' + (this.data.poemElementNum - 5),
        success: res => {
  ...
  preAuthor: function(e) {
    if (this.data.authorElementNum == 0) {} else {
      wx.request({
        url: 'https://www.wshuai.club:8088/huamanxi_wx/pageController/toAuthorPage?authorElementNum=' + (this.data.authorElementNum - 5),
        success: res => {
  ...
  preRhesis: function(e) {
    if (this.data.rhesisElementNum == 0) {} else {
      wx.request({
        url: 'https://www.wshuai.club:8088/huamanxi_wx/pageController/toRhesisPage?rhesisElementNum=' + (this.data.rhesisElementNum - 20),
        success: res => {
          console.log(res.data.rhesisElementNum)
          this.setData({
            rhesis: res.data.rhesisPageRheses,
            rhesisElementNum: res.data.rhesisElementNum
          })
        },
      })
    }
  },
  nextRhesis: function(e) {
    if (this.data.rhesisElementNum >= 200) {} else {
      wx.request({
        url: 'https://www.wshuai.club:8088/huamanxi_wx/pageController/toRhesisPage?rhesisElementNum=' + (this.data.rhesisElementNum + 20),
        success: res => {
          console.log(res.data.rhesisElementNum);
  ...
  onShow: function() {
    wx.request({
      url: 'https://www.wshuai.club:8088/huamanxi_wx/pageController/toPoetryPage',
      header: {
    ...
    wx.request({
      url: 'https://www.wshuai.club:8088/huamanxi_wx/pageController/guessYouLike',
      header: {
        'content-type': 'application/json',
        'cookie': wx.getStorageSync('sessionid')
      },
    ...
    wx.request({
      url: 'https://www.wshuai.club:8088/huamanxi_wx/pageController/toAuthorPage',
      header: {
        'content-type': 'application/json',
        'cookie': wx.getStorageSync('sessionid')
      },
    ...
    wx.request({
      url: 'https://www.wshuai.club:8088/huamanxi_wx/pageController/toRhesisPage',
      header: {
        'content-type': 'application/json',
        'cookie': wx.getStorageSync('sessionid')
      },
